...
class Config:
	SECRET_KEY = os.environ.get('SECRET_KEY') or 'i am a sexy boy'
	...
	SALALCHEMY_RECORD_QUERIES = True
...
config = {'development': DevelopmentConfig, 'testing': TestingConfig, 'production': ProductionConfig, 'default': DevelopmentConfig, 'docker': DockerConfig}
